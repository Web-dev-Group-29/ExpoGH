  ...
  return (
    <div className="regions-wrapper">
      <div className="regions-bg-dark">
        <Image src="/assets/Rectangle 22.png" alt="Page background" fill priority className="object-cover" />
      </div>
          ...
          <div className="regions-map-grid">
            <div className="regions-featured-img-wrap">
              <div className="regions-featured-img">
                <div className="regions-featured-img-inner">
                  <Image src="/assets/accra-ghana.jpg" alt="Beautiful aerial view of a Ghanaian destination" fill className="object-cover" />
                </div>
              </div>
            </div>
            ...
            <div className="regions-map-center">
              <div className="regions-map-hover">
                <Image src="/assets/adobe-ghana.png" alt="Colourful map of Ghana's 16 regions" width={1000} height={1080} className="regions-map-img" priority />
              </div>
            </div>
              ...
              <div className="regions-ashanti-photo">
                <div className="regions-ashanti-img">
                  <div className="regions-ashanti-img-inner">
                    <Image src="/assets/courtyard.jpg" alt="Traditional Ashanti courtyard architecture" fill className="object-cover" />
                  </div>
                </div>
              </div>
              <div className="regions-ashanti-center">
                ...
                <div className="regions-ashanti-map-wrap">
                  <div className="regions-ashanti-map">
                    <Image src="/assets/original-1.png" alt="Map of the Ashanti Region" width={600} height={600} className="regions-ashanti-map-img" />
                  </div>
                </div>
              </div>
              <div className="regions-ashanti-photo">
                <div className="regions-ashanti-img">
                  <div className="regions-ashanti-img-inner">
                    <Image src="/assets/kakum-national-park.png" alt="Kakum National Park rainforest" fill className="object-cover" />
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="regions-aburi-images">
                <div className="regions-aburi-img-wrap">
                  <div className="regions-aburi-img-inner">
                    <Image src="/assets/aburi-botanical-gardens.jpg" alt="Aburi Botanical Gardens View" fill className="object-cover" />
                  </div>
                </div>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                  <a href="https://www.google.com/maps/search/Aburi+Botanical+gardens/@5.8511254,-0.1755178,17z" target="_blank" rel="noopener noreferrer" className="regions-aburi-img-wrap" style={{ display: 'block', cursor: 'pointer' }}>
                    <div className="regions-aburi-img-inner">
                      <Image src="/assets/map-pin-screenshot.png" alt="Map directions to Aburi Botanical Gardens" fill className="object-cover" style={{ transition: 'transform 700ms' }} />
                    </div>
                  </a>
