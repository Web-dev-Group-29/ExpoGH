          ...
          {experiences.map((exp) => (
            <article key={exp.id} onClick={() => setSelectedExp(exp)} className="exp-card">
              <div className="exp-card-img">
                <Image src={exp.image} alt={exp.siteName} fill className="object-cover" sizes="(max-width: 640px) 50vw, 25vw" />
          ...
          <div className="exp-modal">
            ...
            <div className="exp-modal-card">
              ...
              <div className="exp-modal-image">
                <Image src={selectedExp.image} alt={selectedExp.siteName} fill className="object-cover" />
